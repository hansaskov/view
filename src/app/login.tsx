...
export default function () {
	return (
		<div className="min-h-screen flex flex-col">
			<main className="flex-grow flex flex-col gap-6 items-center py-[15vh] lg:py-[25vh]">
				<div role="tablist" className="tabs w-xs tabs-lift">
					<input
						type="radio"
						name="my_tabs_3"
						role="tab"
						...
						checked
					/>
					<div className="tab-content bg-base-100  border border-base-200 p-4">
...
function Google({ children }: { children: ReactNode }) {
	return (
