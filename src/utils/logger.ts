// Stolen from Better-Auth:
// https://github.com/better-auth/better-auth/blob/main/packages/better-auth/src/utils/logger.ts
...
const formatMessage = (level: LogLevel, message: string): string => {
	...
	return `${colors.dim}${timestamp}${colors.reset} ${
		levelColors[level]
	}${level.toUpperCase()}${colors.reset} ${colors.bright}[View]:${
		colors.reset
	} ${message}`
}
